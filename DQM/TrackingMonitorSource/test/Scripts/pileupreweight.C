...
void pileupreweight() {
  TFile* file1 = TFile::Open("ReReco2018_17Sep/Run319910/DQM_V0001_R000319910__Global__CMSSW_X_Y_Z__RECO.root");
  file1->ls();
  TFile* file2 = TFile::Open("ReReco2018_17Sep/MC/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root");
  file2->ls();
  ...
  TFile* f1 = TFile::Open("ReReco2018_17Sep/PileupScaleFactor_319910_wrt_nVertex_ZeroBias.root", "RECREATE");
  hn->Write();
  f1->Write();
  f1->Close();
