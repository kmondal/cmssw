#ifndef RecoEgamma_PhotonIdentification_PhotonMVAEstimatorRunIIFall17_94X_H
#define RecoEgamma_PhotonIdentification_PhotonMVAEstimatorRunIIFall17_94X_H
...
class PhotonMVAEstimatorRunIIFall17_94X : public AnyMVAEstimatorRun2Base{
 ...
 public:
  ...
  PhotonMVAEstimatorRunIIFall17_94X(const edm::ParameterSet& conf);
 ...
 private:
  ...
  const std::string name_ = "PhotonMVAEstimatorRunIIFall1794X";
