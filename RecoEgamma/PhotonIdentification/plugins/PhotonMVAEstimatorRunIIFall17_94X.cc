#include "RecoEgamma/PhotonIdentification/plugins/PhotonMVAEstimatorRunIIFall17_94X.h"
#include "FWCore/ParameterSet/interface/FileInPath.h"
#include "TMVA/MethodBDT.h"
#include <vector>

PhotonMVAEstimatorRunIIFall17_94X::PhotonMVAEstimatorRunIIFall17_94X(const edm::ParameterSet& conf):
...
PhotonMVAEstimatorRunIIFall17_94X::
~PhotonMVAEstimatorRunIIFall17_94X(){
}

float PhotonMVAEstimatorRunIIFall17_94X::
...
int PhotonMVAEstimatorRunIIFall17_94X::findCategory( const edm::Ptr<reco::Candidate>& particle) const {
...
bool PhotonMVAEstimatorRunIIFall17_94X::
...
std::unique_ptr<const GBRForest> PhotonMVAEstimatorRunIIFall17_94X::
createSingleReader(const int iCategory, const edm::FileInPath &weightFile){
  ...
  if( isEndcapCategory(iCategory) ){
    ...
    tmpTMVAReader.AddVariable("esEnergyOverRawE", &allMVAVars_.varESEnOverRawE);
  }
...
std::vector<float> PhotonMVAEstimatorRunIIFall17_94X::fillMVAVariables(const edm::Ptr<reco::Candidate>& particle, const edm::Event& iEvent) const {
...
void PhotonMVAEstimatorRunIIFall17_94X::constrainMVAVariables(AllVariables&)const {
...
void PhotonMVAEstimatorRunIIFall17_94X::setConsumes(edm::ConsumesCollector&& cc) const {
...
DEFINE_EDM_PLUGIN(AnyMVAEstimatorRun2Factory,
                  PhotonMVAEstimatorRunIIFall17_94X,
                  "PhotonMVAEstimatorRunIIFall1794X");
