...
idName = "cutBasedPhotonID-Fall17-92X-V1-Preliminary-loose"
...
idName = "cutBasedPhotonID-Fall17-92X-V1-Preliminary-medium"
...
idName = "cutBasedPhotonID-Fall17-92X-V1-Preliminary-tight"
...
#
cutBasedPhotonID_Fall17_92X_V1_Preliminary_loose  = configureVIDCutBasedPhoID_V5 ( WP_Loose_EB, WP_Loose_EE, isoInputs)
cutBasedPhotonID_Fall17_92X_V1_Preliminary_medium = configureVIDCutBasedPhoID_V5 ( WP_Medium_EB, WP_Medium_EE, isoInputs)
cutBasedPhotonID_Fall17_92X_V1_Preliminary_tight  = configureVIDCutBasedPhoID_V5 ( WP_Tight_EB, WP_Tight_EE, isoInputs)
...
#central_id_registry.register(cutBasedPhotonID_Fall17_92X_V1_Preliminary_loose.idName,
#                             'd6ce6a4f3476294bf0a3261e00170daf')
#central_id_registry.register(cutBasedPhotonID_Fall17_92X_V1_Preliminary_medium.idName,
#                             'c739cfd0b6287b8586da187c06d4053f')
#central_id_registry.register(cutBasedPhotonID_Fall17_92X_V1_Preliminary_tight.idName,
#                             'bdb623bdb1a15c13545020a919dd9530')

cutBasedPhotonID_Fall17_92X_V1_Preliminary_loose.isPOGApproved = cms.untracked.bool(False)
cutBasedPhotonID_Fall17_92X_V1_Preliminary_medium.isPOGApproved = cms.untracked.bool(False)
cutBasedPhotonID_Fall17_92X_V1_Preliminary_tight.isPOGApproved = cms.untracked.bool(False)
