...
mvaFall17v2ClassName = "PhotonMVAEstimatorRunIIFall1794X"
...
mvaRunIIFall17WeightFiles_V2 = cms.vstring(
    "RecoEgamma/PhotonIdentification/data/Fall17_94X/EgammaPhoId_94X_barrel_BDT.weights.xml",
    "RecoEgamma/PhotonIdentification/data/Fall17_94X/EgammaPhoId_94X_endcap_BDT.weights.xml"
    )
...
mvaPhoID_RunIIFall17_v2_producer_config = cms.PSet( 
    ...
    weightFileNames    = mvaRunIIFall17WeightFiles_V2,
    #
